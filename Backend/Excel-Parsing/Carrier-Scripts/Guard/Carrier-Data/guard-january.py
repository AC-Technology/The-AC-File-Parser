...
# GLOBAL VARIABLES
# Carrier Report ID
# This will come from the 'Guard - Janurary 2022' AC Carrier Report URL
carrier_report_id = 5187612000001791069
...
def main():
    ...
    # Read Carrier Data
    carrier_data = pd.read_excel('Guard\Carrier-Data\Guard - AC - OHAGCO99 - JAN2022 - Calendar Year.xlsx')
    ...
    for i, row in carrier_data[2:].iterrows():
        ...
        name_string = agency_name + " - Guard - January 2022"
        ...
        # This is our API call to the CRM API to post a record in the Member Consolidation Module.
