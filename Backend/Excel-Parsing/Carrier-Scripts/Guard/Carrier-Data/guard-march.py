...
# GLOBAL VARIABLES
# Carrier Report ID
# This will come from the 'Guard - March 2022' AC Carrier Report URL
carrier_report_id = 5187612000001500001
...
def main():
    ...
    # Read Carrier Data
    carrier_data = pd.read_excel('Guard\Carrier-Data\Guard - AC - OHAGCO99 - MARCH2022 - Calendar Year.xlsx')
    ...
    for i, row in carrier_data[2:].iterrows():
        ...
        name_string = agency_name + " - Guard - March 2022"
        ...
        # Prior Year Rolling 12 Month Direct Written Premium
