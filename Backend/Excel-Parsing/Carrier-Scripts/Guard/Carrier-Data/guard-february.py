...
# GLOBAL VARIABLES
# Carrier Report ID
# This will come from the 'Guard - February 2022' AC Carrier Report URL
carrier_report_id = 5187612000002126581
...
def main():
    ...
    carrier_data = pd.read_excel(
        'Guard\Carrier-Data\Guard OHAGCO99 - FEB2022 - Calendar Year.xlsx')
    ...
    for i, row in carrier_data[2:].iterrows():
        ...
        name_string = agency_name + " - Guard - February 2022"
