...
# GLOBAL VARIABLES
# Carrier Report ID
# This will come from the 'Main Street America - April 2022' AC Carrier Report URL
...
def main():
    ...
    # Read Carrier Data
    carrier_data = pd.read_excel('Main-Street-America\Carrier-Data\Main Street America YTD by Locations thru April 2022.xlsx')
    # Zoho Account Data
    ...
    # While Loop Search Records
    more_records = True
    agency_code_records =[]
    page = 1
    while more_records:
        search_params = {'criteria': 'Carrier:equals:Main Street America', 'page':page}
    ...
    lob_member_data = []
    print(carrier_data.columns)
    for i, row in carrier_data[21:80].iterrows():
        ...
        print(YTD_NB_DWP_Growth)
        YTD_DWP_Growth = format_number(row['Unnamed: 8'])
        print(YTD_DWP_Growth)
