...
def main():
    ...
    carrier_data = pd.read_excel(
        'Jan 2022 Agency Collective Safeco Trend_Report (42).xlsx',sheet_name="Location")
    ...
    carrier_report_id = 5187612000002241502
    ...
    for i, row in carrier_data.loc[6:].iterrows():
        ...
        name_string = agency_name + " - Safeco - January 2022"
        ...
        Earned_Premium_YTD = row["Earned Premium"]
        ...
        # This is Auto
        AC_Total_ID = 5187612000002373842
        lob_name_string = agency_name + \
        " - Safeco - January 2022 - Auto"
        Report_Date = '2022-01-31'
        ...
        # This is Home
        AC_Total_ID = 5187612000002373837
        lob_name_string = agency_name + \
        " - Safeco - January 2022 - Home"
        Report_Date = '2022-01-31'
        ...
        # This is Specialty
        AC_Total_ID = 5187612000002373832
        lob_name_string = agency_name + \
        " - Safeco - January 2022 - Specialty"
        Report_Date = '2022-01-31'
