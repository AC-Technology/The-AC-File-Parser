...
# GLOBAL VARIABLES
# Carrier Report ID
# This will come from the 'Attune - February 2022' AC Carrier Report URL
carrier_report_id = 5187612000002219337
...
def main():
    ...
    carrier_data = pd.read_excel(
        'Attune\Carrier-Data\Attune AC Group Feb 2022 New_Renewal Production to date.xlsx'
    )
    ...
    for i, row in carrier_data[1:].iterrows():
        ...
        name_string = agency_name + " - Attune - February 2022"
