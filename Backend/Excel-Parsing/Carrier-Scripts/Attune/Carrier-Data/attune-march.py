...
# GLOBAL VARIABLES
# Carrier Report ID
# This will come from the 'Attune - March 2022' AC Carrier Report URL
carrier_report_id = 5187612000002219357
...
def main():
    ...
    carrier_data['2022-03.2'] = carrier_data['2022-03.2'].fillna('')
    carrier_data['2022-03.4'] = carrier_data['2022-03.4'].fillna('')
    carrier_data['2022-03.5'] = carrier_data['2022-03.5'].fillna('')
    carrier_data['2022-03'] = carrier_data['2022-03'].fillna('')
    ...
    for i, row in carrier_data[2:].iterrows():
        ...
        name_string = agency_name + " - Attune - March 2022"

        # This dictionary will hold our API request data when we're ready to send it
        request_body = {}
        YTD_PIF = row['2022-03.5']
        YTD_NB_PIF = row['2022-03']
        YTD_NB_DWP = row['2022-03.2']

        # Total Gross Premium Column
        YTD_DWP = row["2022-03.4"]
        print(YTD_DWP)
