...
# GLOBAL VARIABLES
carrier_report_id = 5187612000002419425
...
def main():
    ...
    carrier_data = pd.read_excel('Mercury\Carrier-Data\Mercury - The AC - Nov 2021.xlsx')
    ...
    page = 1
    while more_records:
        search_params = {'criteria': 'Carrier:equals:Mercury', 'page':page
        }
    ...
    for i, row in carrier_data[2:].iterrows():
        ...
        name_string = agency_name + " - Mercury - November 2021"
        ...
        # if YTD_Loss_Ratio == '--' :
        #     YTD_Loss_Ratio = YTD_Loss_Ratio.replace('--', '0')
        # elif YTD_Loss_Ratio != '--':
        #     YTD_Loss_Ratio = format_number(YTD_Loss_Ratio)
