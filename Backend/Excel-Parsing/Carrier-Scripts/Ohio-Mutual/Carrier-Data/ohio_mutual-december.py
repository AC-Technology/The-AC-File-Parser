...
# GLOBAL VARIABLES
# Carrier Report ID
# This will come from the 'Ohio Mutual - December 2021' AC Carrier Report URL
carrier_report_id = 5187612000002363365
...
def main():
    ...
    # Read Carrier Data
    carrier_data = pd.read_excel('Ohio-Mutual\Carrier-Data\Ohio-Mutual-December.xlsx')
    ...
    page = 1
    while more_records:
        search_params = {'criteria': 'Carrier:equals:Ohio Mutual', 'page':page
        }
    ...
    for i, row in carrier_data.iterrows():
        ...
        name_string = agency_name + " - Ohio Mutual - December 2021"
