...
def main():
    ...
    carrier_data = pd.read_excel('State-Auto\Carrier-Data\State Auto - Agency Collective - Jan 2022.xlsx')
    ...
    carrier_report_id = 5187612000001628367
    ...
    # print(carrier_data)
    for i, row in carrier_data.loc[1:146].iterrows():
        # print(row)
    ...
    for i, row in carrier_data.loc[1:146].iterrows():
        ...
        name_string = agency_name + " - State Auto - January 2022"
